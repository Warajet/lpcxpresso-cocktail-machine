...
void Recipe:: createCocaCola()
{
	...
	pair<Ingredient* , float> cola = make_pair(new Ingredient("Cola", P2_0), 1.00);
...
void Recipe:: createLimeJuice()
{
	...
	pair<Ingredient* , float> lime = make_pair(new Ingredient("Lime", P2_2), 1.00);
...
void Recipe:: createVodkaGimlet()
{
	...
	this->IngredientPortion.clear();
	pair<Ingredient* , float> cola = make_pair( new Ingredient("Cola", P2_0), 0.714);
	pair<Ingredient* , float> vodka = make_pair( new Ingredient("Vodka", P2_1) , 0.143);
...
void Recipe:: createVodkaVanilla()
{
	...
	this->IngredientPortion.clear();
	pair<Ingredient* , float> cola = make_pair( new Ingredient("Cola", P2_0) , 0.658);
	pair<Ingredient* , float> vodka = make_pair( new Ingredient("Vodka", P2_1) , 0.263);
	pair<Ingredient* , float> lime = make_pair( new Ingredient("Lime", P2_2) , 0.079);
